      ...
      <section className="about">
        <div className="about-panel">
          ...
          <div className="about-content">
            <p>
              I am a violinist and educator working on a Master's degree at Juilliard and with a Bachelor's in Computer Science from Columbia University. With a passion for teaching and sharing music, I aim to create a supportive and engaging environment for students of all ages and skill levels.
            </p>
            <p>
